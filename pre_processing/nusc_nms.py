...
from geometry.nusc_distance import iou_bev, iou_3d, giou_bev, giou_3d, d_eucl, fast_giou_3d
...
def blend_nms(box_infos: dict, metrics: str, thre: float) -> List[int]:
    ...
    while sort_idxs.size > 0:
        ...
        left, first = [{'np_dets_bottom_corners': corners[idx], 'np_dets_norm_corners': norm_corners[idx], 'np_dets': infos[idx]} for idx in [sort_idxs[1:], i]]
