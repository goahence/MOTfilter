...
TRANS = np.array([[-0.9999, 0.0093,-0.0023,-0.0018159820647960282],
...
def multi_callback(subscriber_lidar,subscriber_camera):
    ...
    cam_pcs2 = np.dot(pcs_xyz,R) + T
    
    # cam_pcs2 = np.dot(cam_pcs,m1.T)  # degrade the matrix from 4 dimensions to 3 dimensions
